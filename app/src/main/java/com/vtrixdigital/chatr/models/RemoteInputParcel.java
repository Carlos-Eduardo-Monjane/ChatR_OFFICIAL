...
public class RemoteInputParcel implements Parcelable {
    ...
    public RemoteInputParcel(@NonNull RemoteInput input) {
    ...
    public RemoteInputParcel(@NonNull Parcel in) {
        label = in.readString();
    ...
    public void charSequenceToStringArray(@Nullable CharSequence[] charSequence) {
    ...
    public static final Creator CREATOR = new Creator() {
        @NonNull
        public RemoteInputParcel createFromParcel(@NonNull Parcel in) {
